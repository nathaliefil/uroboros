    ...
    class TokenFactory
    {
        ...
        public static Token Build(string code)
        {
            switch (code.ToLower())
            {
                ...
                case "false": return new Token(TokenType.BoolConstant, "false");
                ...
                case "hide": return new Token(TokenType.Hide);
                ...
                case "lock": return new Token(TokenType.Lock);
                ...
                case "unhide": return new Token(TokenType.Unhide);
                case "unlock": return new Token(TokenType.Unlock);
